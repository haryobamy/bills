      ...
      <div className="row">
        <div className="col-lg-8">
          <div className="bg-light shadow-md rounded p-4">
            ...
            <form id="recharge-bill" method="post">
              ...
              <div className="form-group">
                <textarea className="form-control" rows="5" id="yourProblem" required placeholder="Specify your problem"></textarea>
              </div>
        ...
        <div className="col-lg-4 mt-4 mt-lg-0">
          <div className="bg-light shadow-md rounded p-4">
            ...
            <a href="/faq" className="btn btn-link btn-block btn-sm"><u>Click Here for more FAQ</u></a> </div>
        </div>
      </div>
    </div>
  </div>
