          ...
          <div className="bg-light shadow-sm rounded p-4 mb-4">
            ...
            <div className="row profile-completeness">
              <div className="col-sm-6 col-md-3 mb-4 mb-md-0">
                <div className="border rounded p-3 text-center"> <span className="d-block text-10 text-light mt-2 mb-3"><i className="fa fa-mobile-alt"></i></span> <span className="text-5 d-block text-success mt-4 mb-3"><i className="fa fa-check-circle"></i></span>
